...
async function generateLocalPrompts(industry, city) {
  const prompt = `Generate exactly 5 high-intent search prompts a buyer in ${city} would type into ChatGPT, Gemini, Perplexity, or Google AI Overviews when looking for a ${industry} provider.
...
[{"prompt": "best ${industry} in ${city}", "category": "discovery"}, ...]`;
